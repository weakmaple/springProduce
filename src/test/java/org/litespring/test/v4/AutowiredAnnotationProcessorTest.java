...
public class AutowiredAnnotationProcessorTest {
	...
	// 测试读取类中属性（Field）的Autowird注解，将需要主动注入的属性保存在InjectionElement中，
    // 再将InjectionElement保存在InjectionMetadata中，遍历进行inject()
	@Test
	public void testGetInjectionMetadata(){
		//从class当中读取具体的autowired信息的
