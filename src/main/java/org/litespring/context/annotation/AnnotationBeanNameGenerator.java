...
/**
 * @objective : 设置bean的id（如果注解存在value值，就设置value值为bean的id，
 *               如果不存在，就取bean的全类名的最后一个单词，然后首字母小写为bean的id）
...
public class AnnotationBeanNameGenerator implements BeanNameGenerator {
     ...
     */
    // 如果注解存在value，那么设置bean的id为value值，否则设置为null
     ...
     * @return the default bean name (never {@code null})
     */
    // 应付bean的id为null的情况 获取到全类名最后一个单词，然后第一个字母小写
